...
public class PaymentController {
	...
	public ResponseEntity<?> cancelPayment(
		...
		log.info("결제 취소 요청: paymentType={}, referenceId={}, reason={}, amount={}", request.getPaymentType(),
			request.getReferenceId(), request.getCancelReason(), request.getCancelAmount());

		Payment payment = paymentCancellationService.cancelPayment(request.getPaymentType(), request.getReferenceId(),
